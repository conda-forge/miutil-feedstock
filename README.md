...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/miutil-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13827&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/miutil-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `miutil` can be installed with:

```
conda install miutil
```

It is possible to list all of the versions of `miutil` available on your platform with:
